...
public class AddNewSavedItemViewController extends BottomSheetDialogFragment {
    ...
    public static AddNewSavedItemViewController newInstance() {
        return new AddNewSavedItemViewController();
    }
