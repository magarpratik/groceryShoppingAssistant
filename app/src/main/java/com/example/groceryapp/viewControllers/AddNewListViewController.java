...
public class AddNewListViewController extends BottomSheetDialogFragment {
    ...
    public static AddNewListViewController newInstance() {
        return new AddNewListViewController();
    }
