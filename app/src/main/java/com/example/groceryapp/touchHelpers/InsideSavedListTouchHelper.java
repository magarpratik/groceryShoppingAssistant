...
import com.example.groceryapp.adapters.InsideSavedListAdapter;

public class InsideSavedListTouchHelper extends ItemTouchHelper.SimpleCallback {
    private InsideSavedListAdapter adapter;

    public InsideSavedListTouchHelper(InsideSavedListAdapter adapter) {
