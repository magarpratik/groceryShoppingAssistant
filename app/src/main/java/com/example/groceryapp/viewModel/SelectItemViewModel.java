...
import com.example.groceryapp.adapter.SelectItemAdapter;
...
public class SelectItemViewModel extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // Database
        db = new DatabaseHandler(SelectItemViewModel.this);
        db.openDatabase();
